                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo BASE_URL ?>/public/images/logo.jpg" alt="Giới thiệu Web" width="100%">
                        </div>

                        <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/nhan-vat-chinh-cua-naruto-thumbnail.jpg" alt="Mô hình Naruto" width="100%">
                        </div>

                        <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/DC (2).jpg" alt="Mô hình DC" width="100%">
                        </div>

                         <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/marvel.jpeg" alt="Siêu khuyến mãi" width="100%">
                        </div>
                    </div>

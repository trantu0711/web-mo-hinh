            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a target="_blank"  href="https://www.facebook.com/profile.php?id=100027652337043&mibextid=ZbWKwL" class="fb"><img src="<?php echo BASE_URL ?>/public/images/Fb.png">Facebook</a></li>
                           <li><a target="_blank" href="https://www.youtube.com/channel/UCkgdDBHO7zl3tWIjldQeK7g/join" class="fb"><img height="32" width="32" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline: 0837-217-365 </span>
                                    <span class="text_small">(Từ 8h đến 22h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  nguyentrongkhiem365@gmail.com</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  http://localhost/webDoAn/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
